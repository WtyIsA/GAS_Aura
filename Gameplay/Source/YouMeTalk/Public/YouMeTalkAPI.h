...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "YouMeTalkAPI")
		static void SetUserVolume(const FString& userId, const int32 &uiVolume);
	/**
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "YouMeTalkAPI")
		static EYouMeErrorCode SetFarendVoiceLevelCallback(int32 maxLevel, int32 maxMixedLevel);
