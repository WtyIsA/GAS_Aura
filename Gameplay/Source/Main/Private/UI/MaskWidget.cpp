...
{
	MyMask = SNew(SSMaskWidget).Style(&WidgetStyle);

	MyMask->ReIndexClip();

	Brush = WidgetStyle.BackgroundImage;
...
UMaterialInterface* UMaskWidget::GetDynamicMaterial()
{
	UMaterialInterface* Material = NULL;

	UObject* Resource = WidgetStyle.MaskMatBrush.GetResourceObject();
