...
class FSteamSdkInterface: public FSdkInterface
{
public:
	FSteamSdkInterface();
	...
	virtual  void LoginNoUi(int nType){SteamLogin();};
	virtual  void GuestLogin(){SteamLogin();};
	virtual  void Logout(){};
	...
	virtual  bool CanAutoLogin(){return  true;};
