...
//https://www.cnblogs.com/FlyingZiming/p/14573209.html
class FByteSdkAndroidInterface : public FSdkInterface
{
public:
	FByteSdkAndroidInterface():FSdkInterface(){}
	...
	virtual  FString GetLatestUserInfo();
	...
	virtual  bool MobileIsCharging();

	virtual  bool CanAutoLogin();
	...
	virtual  bool IsPermissionGranted(const FString& strPermission);
	virtual  void OpenAppSetting();
	virtual  bool RequestPermission(const FString& strPermission, bool bFirstRequest);
	virtual  bool IsNotificationsAllowed(const FString& strChannelName);
	...
	virtual  FString GetChannelOp();
	virtual  void ChannelGeneralAction(int32 code);
	virtual  bool UnZip(const FString& filePath,const FString& destDirPath, bool bSoFile);
