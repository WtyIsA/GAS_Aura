...
public class RTCEventHandler implements IGameRTCEventHandler {
    ...
    @Override
    public void onPerfAdjustResult(PerfAdjustDirection perfAdjustDirection, PerfAdjustResult perfAdjustResult) {

    }

    public void onRecordingStateUpdate(RecordingState recordingState, RecordingErrorCode recordingErrorCode, String s) {

    }

  
    public void onRecordingProgressUpdate(RecordingProgress recordingProgress, String s) {
