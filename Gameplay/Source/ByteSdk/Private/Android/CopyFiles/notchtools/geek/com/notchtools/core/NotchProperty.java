...
public class NotchProperty {
    ...
    public boolean getNotchIsHide(){return mIsNotchHide;}
    public void setNotchHide(boolean notchisHide){this.mIsNotchHide = notchisHide;}
}
