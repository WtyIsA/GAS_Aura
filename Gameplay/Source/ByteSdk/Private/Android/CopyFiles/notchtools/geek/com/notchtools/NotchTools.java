...
public class NotchTools  {
    ...
    public static NotchTools getFullScreenTools() {
        NotchStatusBarUtils.sShowNavigation = false;
    ...
    public void fullScreenUseStatusForActivityOnCreate(final Activity activity) {
		View mainRootView = activity.getWindow().getDecorView().findViewById(android.R.id.content).getRootView();
    ...
    public void fullScreenUseStatusForOnWindowFocusChanged(final Activity activity,  final OnNotchCallBack notchCallBack) {
        fullScreenUseStatus(activity, notchCallBack);
    }
