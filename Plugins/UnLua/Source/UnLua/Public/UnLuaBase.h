...
{   
    ...
    {   
        ...
        virtual void SetUObject(UObject* obj) {}
        virtual void CheckNetChange(){}
    ...
    UNLUA_API void DelegateUnBind(const FScriptDelegate *ScriptDelegate);
    UNLUA_API bool ReleaseLuaCallback(const UObject* Object, const FString& funName);
    UNLUA_API void AddObjectReferencer(UObject* Object);
    UNLUA_API void RemoveObjectReferencer(UObject* Object);
    UNLUA_API bool ReleaseLuaCallback(const UObject* Object, const void* luaFun);
    UNLUA_API const FString& GetDonwloadResPath();
    UNLUA_API void SetLuaSearchPaths(const TArray<FString>& luaPaths);
} // namespace UnLua
